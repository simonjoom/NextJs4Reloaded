...
function getSingleton() {
  if (global.SingletonRouter) {
    return global.SingletonRouter
  }
...
global.SingletonRouter=SingletonRouter;

function throwIfNoRouter() {
  if (!global.SingletonRouter.router) {
...
const SingletonRouter=getSingleton();
// Export the SingletonRouter and this is the public API.

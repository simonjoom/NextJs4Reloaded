...
module.exports = function (content, sourceMap) {
  ...
  // We can safely check if Component is undefined since all other pages imported into the entrypoint don't have __webpack_exports__.default
    ...
    this.callback(null, "".concat(content, "\n    ; (function (Component, route) {\n      if(!Component) return\n ; window.__NEXT_REGISTER_PAGE(").concat(stringify(route), ", function() {             \n        return {page: Component}\n      },module)\n   })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), ").concat(stringify(route), ")\n  "), sourceMap);

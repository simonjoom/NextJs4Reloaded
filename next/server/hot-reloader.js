...
export default class HotReloader {
  ...
  singleCompiler.hooks.afterEmit.tapAsync("prepareBuildTools",(compilation, callback)=>{
  ...
  compiler.compilers[0].hooks.done.tap("prepareBuildTools",(stats)=> {
    ...
    const webpackHotMiddleware = WebpackHotMiddleware(compiler.compilers[0], {
      path: '/_next/webpack/webpack-hmr',
      log: false,
      heartbeat: 2500
    })
